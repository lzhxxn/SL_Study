...
<div class="section-content no-search-cols">
	...
	<form name="formComuser" id="formComuser">
		...
		<table class="table-group">
					...
					<div class="ranges-group">
						<div class="range-10">
							<input type="text" name="user_id"
								value="<c:out value="${param.user_id}" />" class="form-text"
								maxlength="30"
								data-valid="<spring:message code="FLD.COM.0148"/>,required,alphanum" readonly>
						</div>
					</div>
				</td>
			...
			<tr>
				...
				<td>
					<div class="ranges-group">
						<div class="range-10">
							<input type="text" name="user_nm" class="form-text"
								maxlength="30"
			...
			<tr>
				...
				<td>
					<div class="ranges-group">
						<div class="range-10">
							<input type="password" name="passwd" class="form-text"
								maxlength="30" >
						</div>
					</div>
				</td>
			...
			<tr>
				...
				<td>
					<div class="ranges-group">
						<div class="range-10">
							<input type="password" name="passwd2" class="form-text"
			...
			<tr>
				...
				<td>
					<div class="ranges-group">
						<div class="range-10">
							<input type="tel" name="tel_no" class="form-text" maxlength="15"
								data-valid="<spring:message code="FLD.COM.0154"/>,phone" readonly>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="ranges-group">
						<div class="range-10">
							<input type="tel" name="mobile_no" class="form-text"
								maxlength="15"
								data-valid="<spring:message code="FLD.COM.0150"/>,required,phone" readonly>
						</div>
					</div>
				</td>
				<td>
			...
			<tr>
				...
				<td colspan="2">
					<div class="ranges-group">
						<div class="range-6">
							<input type="email" name="mail_addr" class="form-text"
								maxlength="100"
								data-valid="<spring:message code="FLD.COM.0151"/>,required,email" readonly>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td colspan="2"><input type="text" name="line_token"
					class="form-text" maxlength="300" readonly></td>
			</tr>
		...
		<div class="table-bottom">
			<button type="button" class="btn-basic btn-confirm"
				data-after-close="true">
				승인
			</button>
  			 <button type="button" class="btn-basic btn-reject"
				data-after-close="true">
				거절
			</button>
...
<script
	src="<c:url value="/resources/app/system/user/user_apply_form.js" />"></script>
