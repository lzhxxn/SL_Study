...
<!--  jqxWindow -->
<div id="storage_dlg" style="display: none;" class="container">
	<div><spring:message code='TITLE.STOR.0001'/></div>
	<div>
		<form id="formStorage" name="formStorage">
			...
			<div class="tab-group">
			<ul class="config_tab">
				<li class="tab-item-active"><a href="#" class="tab-button">기본설정</a></li>
				<li><a href="#" class="tab-button">고급설정</a></li>
			</ul>
		</div>
		
			<div class="defaultTab" style="display:block">
			...
			<table class="table-group">
				<tr>
					...
					<td data-ui="tooltip" data-text="<spring:message code='INF.STOR.0001'/>">
						<input type="text" name="storage_id" class="form-input" data-valid="<spring:message code='FLD.STOR.0001'/>,required" maxlength="25">
					</td>
				</tr>
				<tr>
			...
			<table class="table-group">
				<tr>
					...
					<td>
						<div class="ranges-group">
							<div class="range-4 form-label"><label data-ui="tooltip" data-text="원본로그로부터 검색어에 해당하는 로그를 자동으로 스토리지에 분리저장할지 여부"><input type="radio" name="divide_yn" class="form-transform" value="Y"><span class='form-clone'></span>&nbsp;True</label></div>
							<div class="range-4 form-label"><label data-ui="tooltip" data-text="원본로그로부터 검색어에 해당하는 로그를 자동으로 스토리지에 분리저장할지 여부"><input type="radio" name="divide_yn" class="form-transform" value="N" checked="checked"><span class='form-clone'></span>&nbsp;False</label></div>
						</div>
					</td>
				</tr>
				...
				<div class="advancedTab" style="display:none">
				<div class="title-group">
					<h4>카테고리정보</h4>
				</div>
				<table class="table-group">
			...
			<table class="table-group">
				...
				<div class="otherInformation" style="margin-top: 10px;">
				<div class="title-group">
					<h4>기타정보</h4>
				</div>
				<table class="table-group">
				<tr class="tr-usedisk-manager">
