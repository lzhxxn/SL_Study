...
<div class="section-content no-search-cols">
	...
	<form name="formComuser" id="formComuser">
					...
					<div class="ranges-group">
						<div class="range-10">
							<input type="tel" name="mobile_no" class="form-input"
								maxlength="15"
								data-valid="<spring:message code="FLD.COM.0150"/>,phone">
						</div>
					</div>
				</td>
				<td>
		...
		<div class="table-bottom">
			<button type="button" class="btn-basic btn-save"
				data-after-close="true">
				<spring:message code="BTN.COM.0005" />
			</button>
			<button type="button" class="btn-basic btn-delete"
				data-after-close="true">
				<spring:message code="BTN.COM.0003" />
			</button>
			<button type="button" class="btn-basic btn-cancel"
				data-layer-close="true">
				<spring:message code="BTN.COM.0014" />
			</button>
		</div>
...
<script
	src="<c:url value="/resources/app/system/user/comuser_form.js" />"></script>
